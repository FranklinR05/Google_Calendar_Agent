...
main_agent_system_prompt = textwrap.dedent(""" You are a main agent. For Calendat related tasks, transfer to Google Calendar Agent first""")
...
1. Use the list_calendar_events function to retrieve a list of calendars that are available in your Google Calendar account.
...
2. Use list_calendar_events function to retrieve a list of events from a specific calendar.    
    -Example usage: 
        ...
        - If you want to retrieve events from a specific calendar, replace 'primary' with calendar ID.
            calendar_list = list_calendar_list(max_capacity=50)
            search calendar if from calendar_list
...
4. Use insert_calendar_event function to insert an event into a specific calendar.
    ...
    event_details = {
        ...
        'start':{
            'dateTime' : '2025-10-01T10:00:00-07:00',
